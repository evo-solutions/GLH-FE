...
import { TabDataNote } from "../ui/TabDataNote";
import type {
...
import { animateValue } from "../utils/format";
import { drawSpark } from "../utils/sparkline";

export function GoldenLotusScreens({ screen }: { screen: ScreenId }) {
  ...
  return (
    <>
      <section
        className={`gl-screen ${screen === "dashboard" ? "gl-screen-active" : ""}`}
      ...
      <section
        className={`gl-screen ${screen === "vendors" ? "gl-screen-active" : ""}`}
        hidden={screen !== "vendors"}
      >
        <TabDataNote
      ...
      <section
        className={`gl-screen ${screen === "sku" ? "gl-screen-active" : ""}`}
        hidden={screen !== "sku"}
      >
        <TabDataNote
          perm={t("sku.tabPerm")}
      ...
      <section
        className={`gl-screen ${screen === "customer" ? "gl-screen-active" : ""}`}
        hidden={screen !== "customer"}
      >
        <TabDataNote
      ...
      <section
        className={`gl-screen ${screen === "campaign" ? "gl-screen-active" : ""}`}
        hidden={screen !== "campaign"}
      >
        <TabDataNote
      ...
      <section
        className={`gl-screen ${screen === "research" ? "gl-screen-active" : ""}`}
        hidden={screen !== "research"}
      >
        <TabDataNote
      ...
      <section
        className={`gl-screen ${screen === "cases" ? "gl-screen-active" : ""}`}
        hidden={screen !== "cases"}
      >
        <TabDataNote
      ...
      <section
        className={`gl-screen ${screen === "hrm" ? "gl-screen-active" : ""}`}
        hidden={screen !== "hrm"}
      >
        <TabDataNote
          perm={t("hrm.tabPerm")}
      ...
      <section
        className={`gl-screen ${screen === "ai" ? "gl-screen-active" : ""}`}
        hidden={screen !== "ai"}
      >
        <TabDataNote
      ...
      <section
        className={`gl-screen ${screen === "settings" ? "gl-screen-active" : ""}`}
